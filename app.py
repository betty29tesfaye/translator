...
text_to_translate = st.text_input("Please enter the text you want to translate (እባከዎ መተርጎም የሚፈልጉትን ይፃፉ)")
st.button('Translation(ትርጉም)')
if text_to_translate and st.button('Translation(ትርጉም)'):
